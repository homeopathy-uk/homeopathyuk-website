...
The BHA most strongly refutes the allegation that its submission was one of any that offered a selective account of the research evidence in homeopathy.  We have already published a [detailed rebuttal of the Committee’s unfounded criticisms]/media_centre/news/STC_part_1.html).  The BHA’s submission is a well-rounded, factual and balanced summary of the available evidence, and whose key focus is on condition-specific research, including the conclusions from the 17 systematic reviews cited under Recommendation 11 above.  It is regrettable that the Committee chose to disregard this approach and the informative and constructive manner in which it was intended.
